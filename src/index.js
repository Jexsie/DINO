...
function initialize() {
  ...
  // 2) Remove old global handlers
  document.ontouchstart = null;
  document.body.onclick = null;

  // 3) Canvas-only mouse/touch
...
function resizeCanvas() {
  ...
  canvas.height = ROWS; // keep fixed height, or adjust as needed
...
async function useNFT() {
  console.log("useNFT");
  try {
    // For demo, load your sample JSON (you can swap this with an IPFS gateway link or wallet NFT fetch)
